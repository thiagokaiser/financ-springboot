...
public class UsuarioController {
  ...
  public ResponseEntity<UsuarioDTO> find(@PathVariable Integer id) {
    UsuarioEntity obj = service.find(id);
  ...
  public ResponseEntity<UsuarioDTO> find(@PathVariable String email) {
    UsuarioEntity obj = service.findByEmail(email);
    UsuarioDTO objDto = new UsuarioDTO(obj);
    return ResponseEntity.ok().body(objDto);
  }
  ...
  public ResponseEntity<Void> insert(@Valid @RequestBody UsuarioNewDTO objDto) {
    UsuarioEntity obj = service.fromDTO(objDto);
  ...
  public ResponseEntity<Page<UsuarioDTO>> findPage(
    ...
    Page<UsuarioEntity> list = service.findPage(page, linesPerPage, orderBy, direction);
